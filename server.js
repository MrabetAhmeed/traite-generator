...
const ZONES = {
  ...
  RIB:                [{ x:153.1, y:topY(85.4),  w:187.1, h:14.9 }, { x:23.0,  y:topY(205.6), w:186.7, h:14.9 }],
  Montant:            [{ x:373.8, y:topY(83.0),  w:102.7, h:13.0 }, { x:372.4, y:topY(124.7), w:102.6, h:12.9 }],
  Montant_en_lettres: [{ x:17.8,  y:topY(150.0), w:403.0, h:11.0 }],
  A_lordre_de:        [{ x:145.4, y:topY(138.7), w:203.9, h:16.8 }],
  Payeur:             [{ x:225.5, y:topY(256.7), w:92.6,  h:40.3 }],
  Banque:             [{ x:330.0, y:topY(220.2), w:139.1, h:20.6 }],
};
